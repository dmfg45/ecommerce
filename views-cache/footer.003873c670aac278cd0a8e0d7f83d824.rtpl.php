...
<div class="footer-bottom-area">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="copyright">
                    <p>&copy; 2019 AG LearningProjects.</p>
                </div>
            </div>
...
<script src="/assets/public/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="/assets/public/js/jquery.easing.1.3.min.js"></script>
...
<script type="text/javascript" src="/assets/public/js/script.slider.js"></script>
</body>
</html>